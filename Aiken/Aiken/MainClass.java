   ...
   JFrame f;
    ...
    void prepareGUIforfile()
    {
       ...
       font = new Font("Comic Sans Ms",Font.PLAIN,18);
        ...
        final Button b=new Button("Create file");  
        b.setFont(font);
                ...
                else
                {
                    try {
                        ...
                        if (myObj.createNewFile()) {
                           ...
                           but2=new Button("Still Continue");
    ...
    void showButtonDemo()
    {
        ...
        next.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e){
                ...
                String file="F:/Old/hp/Music/TY sem 5/VS/Project 1/Aiken/"+ lastfilenamerefernce;
